...
namespace modules\firebellymodule;

use modules\firebellymodule\assetbundles\firebellymodule\FirebellyModuleAsset;
 ...
 *
 */
class FirebellyModule extends Module
{
    // Static Properties
    // =========================================================================
    ...
    {
        Craft::setAlias('@modules/firebellymodule', $this->getBasePath());
        $this->controllerNamespace = 'modules\firebellymodule\controllers';
        ...
        if (!isset($i18n->translations[$id]) && !isset($i18n->translations[$id.'*'])) {
            $i18n->translations[$id] = [
                ...
                'basePath' => '@modules/firebellymodule/translations',
        ...
        if (Craft::$app->getRequest()->getIsCpRequest()) {
            Event::on(
                ...
                function (TemplateEvent $event) {
                    try {
                        Craft::$app->getView()->registerAssetBundle(FirebellyModuleAsset::class);
